...
vocab: {
  "word-uuid": {
    ...
    learningStage: 1,            // 1=翻卡自评，2=释义选择，3=例句语境选择，4=已掌握
...
用户点击“不认识”或“模糊”时，`status` 会变为 `weak`，`weakCount` 增加。词汇页会立刻显示中文释义、英文释义和例句，并优先安排薄弱词复习。

三关制掌握流程：

1. 第一关：翻卡自评。答对后进入第二关，答错留在第一关。
2. 第二关：从 4 个释义中选择正确释义。答错则下次继续第二关。
3. 第三关：根据例句语境选择词义。答错则下次继续第三关。
4. 第三关答对后进入 `mastered`。
