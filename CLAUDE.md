...
| 阶段 1：MVP（计划+词汇） | ✅ 已完成扩展版 | 备考计划生成、今日任务、SM-2 词汇复习、薄弱词优先复习、完整 IELTS 词库接入 |
...
内置词汇表位于 `frontend/js/utils/vocab-data.js`，完整导入词库位于 `frontend/js/utils/ielts-4000-data.js`。当前已接入完整 IELTS 词库并保留精选中文词条，后续扩展时优先使用可追踪来源：
